...
# from replit import clear esto pertenece al IDE Replit.
...
def game():
    ...
    while game_should_continue:
        ...
        # clear() < El clear pertenece al IDE replit, en pycharm no se encuentra. El clear es para limpiar la consola.
        # print(logo)
        if is_correct:
            score += 1
